[![Unit Tests](https://github.com/amattas/hass-dmp/actions/workflows/pythonpackage.yaml/badge.svg?branch=master)](https://github.com/amattas/hass-dmp/actions/workflows/pythonpackage.yaml)
