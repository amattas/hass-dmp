...
# ------------------------------------------------------------------------------
# Consolidated DMPSender Initialization and Command Tests
# ------------------------------------------------------------------------------
class TestDMPSenderInitialization:
    """Test DMPSender initialization and account number formatting."""
...
class TestDMPSenderCommands:
    """Test DMPSender arm, disarm, and bypass commands."""
...
class TestDMPCharReply:
    """Test DMPCharReply static methods."""
